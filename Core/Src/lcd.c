...
{
    char buffer[11];  // Adjust the buffer size as needed
    sprintf(buffer, "%.1f", number);  // Adjust the format specifier as needed

    // Assuming you have a function named LCD_string in your LCD library
    Lcd_string(lcd, buffer);
}
